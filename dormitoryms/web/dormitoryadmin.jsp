...
<nav class="navbar navbar-inverse  " role="navigation" style="border: none">
    <div class="container-fluid" style="background-color: rgb(91,127,215)">
        ...
        <ul class="nav navbar-nav navbar-right">
            <li>
                <a style="color: white;">欢迎${dormitoryAdmin.name}</a>
            </li>
            <li>
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-2">
            ...
            <a href="javascript:void(0)" class="list-group-item" onclick="change('/searchpassword?method=sisearch&name=${dormitoryAdmin.name}',2)">
						<span class="" aria-hidden="true">
