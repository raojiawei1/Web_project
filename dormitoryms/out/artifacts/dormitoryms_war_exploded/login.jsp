...
<body>
<div class="container">
  <div class="form row" style="height: 310px;width: 350px;  border-radius:15px ;">
    <form class="form-horizontal col-md-offset-3" id="login_form" action="<%= request.getContextPath()%>/account?method=login" method="post">
      <h3 class="form-title" style=" color: #40E0D0;margin-left: 10px">宿舍管理系统</h3>
      <div class="col-md-9">
        ...
        <div class="form-group col-md-offset-9">
          <button type="submit" class="btn btn-success pull-left" name="submit" style="background-color: #40E0D0;">登录</button>
          <button type="reset" class="btn btn-success pull-right" name="submit" style="background-color: #40E0D0;">重置</button>
        </div>
      </div>
    </form>
  </div>
